Vue.component('navbar-component',{
    ...
    <ul class="list-unstyled components" style="padding:0">
        <p>Welcome</p>
        <li>
            <a href="https://payroll.cleverapps.io/dashboard"><i class="fa fa-tachometer" style="color:blue" aria-hidden="true"></i>&nbsp Dashboard</a>
        </li>
        <li >
            ...
            <ul class="collapse list-unstyled" id="employee" data-parent="#sidebar">
                <li>
                    <a href="https://payroll.cleverapps.io/employee/add_emp"><i class="fa fa-ellipsis-h" style="color:green"aria-hidden="true"></i>&nbsp Add Employee</a>
                </li>
                <li>
                    <a href="https://payroll.cleverapps.io/employee/manage_emp"><i class="fa fa-ellipsis-h" style="color:green"aria-hidden="true"></i>&nbsp Manage Employee</a>
                </li>
            </ul>
        </li>
        <li >
            ...
            <ul class="collapse list-unstyled" id="department" data-parent="#sidebar">
                <li>
                    <a href="https://payroll.cleverapps.io/department/add_dep"><i class="fa fa-ellipsis-h" style="color:yellow"aria-hidden="true"></i>&nbsp Add Department</a>
                </li>
                <li>
                    <a href="https://payroll.cleverapps.io/department/manage_dep"><i class="fa fa-ellipsis-h" style="color:yellow"aria-hidden="true"></i>&nbsp Show Department</a>
                </li>
            </ul>
        </li>
        <li >
            ...
            <ul class="collapse list-unstyled" id="attendance" data-parent="#sidebar">
                <li>
                    <a href="https://payroll.cleverapps.io/attendance/daily_attendance"><i class="fa fa-ellipsis-h" style="color:lightgreen"aria-hidden="true"></i>&nbsp Daily Attendance</a>
                </li>
                <li>
                    <a href="https://payroll.cleverapps.io/attendance/attendance_report"><i class="fa fa-ellipsis-h" style="color:lightgreen"aria-hidden="true"></i>&nbsp Attendance Report</a>
                </li>
            </ul>
        </li>
        <li >
            ...
            <ul class="collapse list-unstyled" id="holiday" data-parent="#sidebar">
                <li>
                    <a href="https://payroll.cleverapps.io/holiday/add_holiday"><i class="fa fa-ellipsis-h" style="color:rgb(209, 137, 4)"aria-hidden="true"></i>&nbsp Add Holiday</a>
                </li>
                <li>
                    <a href="https://payroll.cleverapps.io/holiday/manage_holiday"><i class="fa fa-ellipsis-h" style="color:rgb(209, 137, 4)"aria-hidden="true"></i>&nbsp Manage Holiday</a>
                </li>
            </ul>
        </li>
        <li >
        ...
        <li >
            ...
            <ul class="collapse list-unstyled" id="setting" data-parent="#sidebar">
                <li>
                    <a href="https://payroll.cleverapps.io/settings/change_password"><i class="fa fa-ellipsis-h" style="color:rgb(196, 5, 5)"aria-hidden="true"></i>&nbsp Change Password</a>
                </li>
                <li>
                    <a href="https://payroll.cleverapps.io/settings/configrations"><i class="fa fa-ellipsis-h" style="color:rgb(196, 5, 5)"aria-hidden="true"></i>&nbsp Configurations</a>
                </li>
            </ul>
        </li>
        <li >
            ...
            <ul class="collapse list-unstyled" id="user" data-parent="#sidebar">
                <li>
                    <a href="https://payroll.cleverapps.io/users/add_user"><i class="fa fa-ellipsis-h" style="color:coral"aria-hidden="true"></i>&nbsp Add User</a>
                </li>
                <li>
                    <a href="https://payroll.cleverapps.io/users/manage_user"><i class="fa fa-ellipsis-h" style="color:coral"aria-hidden="true"></i>&nbsp Manage User</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="https://payroll.cleverapps.io/auth/logout"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp Logout</a>
        </li>
    </ul>
    ...
    <div class="dropdown2" >
      ...
      Administrator 
        ...
        <div class="dropdown2-content">
            <a href="https://payroll.cleverapps.io/settings/profile" >Profile</a>
            <a href="https://payroll.cleverapps.io/settings/change_password" class="hov">Change Password</a>
            <a href="https://payroll.cleverapps.io/settings/configrations" class="hov">Configrations</a>
            <a href="https://payroll.cleverapps.io/auth/logout" class="hov">Logout &nbsp<i class="fa fa-sign-out" aria-hidden="true"></i> </a>
          </div>
    </div>
    </div>
